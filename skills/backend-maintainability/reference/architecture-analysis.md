...
Durable context lives in `.backend/ARCHITECTURE.md`. Inventory facts are regenerable. Do not invent a design.
...
7. Update `.backend/ARCHITECTURE.md`. Never silently overwrite completed semantic sections.

...
| `plan` | Build the cleanup DAG from merged findings and reviews | [reference/cleanup-planning.md](reference/cleanup-planning.md), [reference/plan.md](reference/plan.md) |
...
| `install` | Copy the Cursor adapter, optional prevention rule, and `check --changed` hooks | [reference/install.md](reference/install.md) |
